...
import {
  ...
  FriendshipChallengeGenerator,
  GlowStickDanceChallenge,
  GuessTheAnimal,
  KindnessChallengeSpinner,
  MadLibsStoryMaker,
  SpeedDrawingChallenge,
  SpinTheDareWheel,
  StarGirlAwards,
  TalentShowBuzzer,
  UltimateTrivia,
...
const SECTION_CATEGORIES: SectionCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: "mad-libs",
        label: "Mad Libs Story Maker",
        emoji: "📖",
        component: MadLibsStoryMaker,
      },
      {
        id: "brain-teasers",
        label: "Brain Teaser Riddles",
        emoji: "🧩",
        component: BrainTeaserRiddles,
      },
      {
        id: "kindness-spinner",
        label: "Kindness Challenge Spinner",
        emoji: "💖",
        component: KindnessChallengeSpinner,
      },
      {
        id: "emoji-code-breaker",
        label: "Emoji Code Breaker",
        emoji: "🔐",
        component: EmojiCodeBreaker,
      },
      {
        id: "fortune-cookie",
        label: "Fortune Cookie Generator",
        emoji: "🥠",
        component: FortuneCookieGenerator,
      },
      {
        id: "speed-drawing",
        label: "Speed Drawing Challenge",
        emoji: "🎨",
        component: SpeedDrawingChallenge,
      },
      {
        id: "guess-animal",
        label: "Guess the Animal!",
        emoji: "🐾",
        component: GuessTheAnimal,
      },
      {
        id: "friendship-challenge",
        label: "Friendship Challenge",
        emoji: "👭",
        component: FriendshipChallengeGenerator,
      },
      {
        id: "compliment-battle",
        label: "Compliment Battle",
        emoji: "💬",
        component: ComplimentBattle,
      },
    ],
  },
  {
